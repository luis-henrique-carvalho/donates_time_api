...
ActiveRecord::Schema[7.1].define(version: 20_240_810_122_611) do
  ...
  create_table 'ongs', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'updated_at', null: false
    t.integer 'category', default: 0, null: false
    t.integer 'actions_limit', default: 6, null: false
  ...
  create_table 'volunteers', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[user_id action_id], name: 'index_volunteers_on_user_id_and_action_id', unique: true
